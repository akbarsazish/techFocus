      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 isolate tertiary px-6 py-32 sm:py-44 lg:px-12">
          <div className="p-4">
              ...
              <p className="text-white pt-4">
                 We’d love to hear from you! Whether you have questions, feedback, or need assistance, our team is here to help. Please fill out the contact form below, and we’ll get back to you as soon as possible. Your thoughts are important to us, and we look forward to connecting with you!
              </p>
              <div className="mt-10">
                <FaBuilding className="text-white inline text-2xl" /> <span className="text-white"> 3rd block, Herat street, Texax. </span>
              </div>
              <div className="mt-4">
                <FaPhone className="text-white inline text-2xl" /> <span className="text-white"> +19222200002 </span>
              </div>
              <div className="mt-4">
                <FaMobileAlt className="text-white inline text-2xl" /> <span className="text-white"> techfocus@gmail.com </span>
              </div>
          </div>
