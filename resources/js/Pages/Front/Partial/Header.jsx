                ...
                <div className="hidden sm:ml-6 sm:block">
                    <div className="flex space-x-4">
                        ...
                        <div className="relative group">
                            <a 
                                type="button" 
                                className="about rounded-md px-3 py-2 text-sm font-medium text-white cursor-pointer inline-block" 
                                id="menu-button" 
                                aria-expanded="true" 
                                aria-haspopup="true"
                            >
                        ...
                        <div className="absolute hidden group-hover:block right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                            <div className="py-1" role="none">
                                <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1" id="menu-item-0">About Us</a>
                                <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1" id="menu-item-1">Team</a>
                                <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1" id="menu-item-2">Customers</a>
