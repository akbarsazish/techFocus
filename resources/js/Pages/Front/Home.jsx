          ...
          <div className="max-w-auto">
            <div className="flex flex-row p-20 text-white bg-[url('../../public/images/banner.jpg')] bg-no-repeat bg-cover bg-center h-screen">
                  <div className="className mt-16">
                      <h1 className="text-4xl mb-2"> Welcome to TechFocus </h1>
                      <p className="text-xl">
                      ...
                      <button className="bg-transparent hover:bg-gray-800 text-white-700 font-semibold border border-white-500 hover:text-white py-2 px-4 rounded">
                          Start With Us
                      </button>
                      </div>
                  </div>
            ...
            <div className="section p-20">
                ...
                <div className="grid grid-cols-4 gap-4 text-center text-gray">
                    <div className="bg-gray-100 rounded h-56 -mt-10">
                        <h2 className="font-bold text-2xl mt-5"> Web and Mobile App Development</h2>
                    </div>
                    <div className="bg-gray-100 rounded h-56">
