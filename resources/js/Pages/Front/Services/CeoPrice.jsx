...
export default function CeoPrice() {
  return (
    <FrontLayout>
    <div className="relative isolate px-6 py-24 sm:py-32 lg:px-6">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-white">
        The price of website SEO services with a limited discount.
      </p>
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured ? 'relative shadow-2xl' : 'bg-white/60 sm:mx-8 lg:mx-0',
              tier.featured
                ? ''
                : tierIdx === 0
                  ? 'rounded-t-3xl sm:rounded-b-none lg:rounded-bl-3xl lg:rounded-tr-none'
                  : 'sm:rounded-t-none lg:rounded-bl-none lg:rounded-tr-3xl',
              'rounded-3xl p-4 ring-1 sm:p-5',
            )}
          >
            <h3
              id={tier.id}
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ? 'text-white bg-indigo-600 shadow-sm hover:bg-indigo-400 focus-visible:outline-indigo-500 '
